...
$(function() {
    ...
    var menuShow = $(".mobile-menu .fa-bars"),
        ...
        personalSkill1 = 78, // ========>  (Communication)
        personalSkill2 = 65, // ========>  (Team Work)
        personalSkill3 = 59, // ========>  (Css)
        personalSkill4 = 80, // ========>  (NodeJs)

        //  Professional Skills Percentage
        professionalSkill1 = 41, // ====>  (PHP)
        professionalSkill2 = 37, // ====>  (Sass)
        professionalSkill3 = 23, // ====>  (Bash)
        professionalSkill4 = 15; // ====>  (Yaml)
    //  ======================================================
